...
!     local variables
      ...
      call fgslib_gs_op(gsh_ext,field_out,1,1,0) ! sum
...
c     GS operation to extend ieg_nei
      ...
      call fgslib_gs_op(gsh_ext,ieg_nei,2,1,0) ! 2->integer, 1->sum, 0->does not matter
      
c     Free gs
      call fgslib_gs_free(gsh_ext)
...
c     Use global numbering for the handle
      ...
      call fgslib_gs_setup(gsh_ext,glo_num_ext,ntot_ext,nekcomm,mp)            
